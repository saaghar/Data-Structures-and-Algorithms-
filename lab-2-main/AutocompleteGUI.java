...
public class AutocompleteGUI extends JFrame {
  ...
  // for serializable classes
     ...
     * @param maxMatches the maximum number of suggestions to return
     */
    ...
    private class AutocompletePanel extends JPanel {
        ...
        private Autocompleter auto;               // the Autocompleter object
        private String[] results = new String[maxMatches]; // an array of matches
